...
const CardCar = ({
  ...
  useEffect(() => {
    const handleCurrencyChange = () => {
      setSelectedCurrency(sessionStorage.getItem("selectedCurrency") || "yuan");
    };
        ...
        {top && (
          <div
            className={`absolute top-0 ${
              goodPrice ? "left-0" : "left-[150px] max-md:left-[95px]"
      ...
      <div className="flex flex-col">
        ...
        <div className="grid grid-cols-3 gap-[5px] pb-3 border-b border-[#E6E6E6]">
          <div className="flex items-center justify-start border h-[48px] px-3 rounded-[5px] max-md:px-2 max-md:h-[38px]">
            ...
            <p className="text-[#202020] font-medium text-sm max-md:text-[11px] text-8px">
              {speed}&nbsp;км
            </p>
          </div>
          <div className="flex items-center justify-start border h-[48px] px-3 rounded-[5px] max-md:px-2 max-md:h-[38px]">
